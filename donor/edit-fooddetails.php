...
<!DOCTYPE html>
<head>
<title>Re Food Share   | Food Updation </title>
...
<td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="description" id="description" required="true" value="<?php echo $row['Description'];?>" pattern="[0-9]+">
                        </div>
                    </div>
                    <div class="form-group">
